...
describe('find all', function () {
  before(function(){
    var name = "attr-" + randomstring.generate();
  ...
  it('should return a valid list of media types', function (done) {
    models.destination_attribute_category_types.findAll().then(function(destination_attribute_category_types) {
      destination_attribute_category_types.length.should.be.greaterThan(0);
      done();
    });
  });
});
...
it('should return a valid tag', function (done) {
      models.destination_attribute_category_types.findOne({ where: { id: 1 }
    }).then(function(destination_attribute_category_types) {
      destination_attribute_category_types.id.should.be.greaterThan(0);
      destination_attribute_category_types.created.should.be.greaterThan(0);
      destination_attribute_category_types.updated.should.be.greaterThan(0);  
