...
* Create feature branches that reference Trello cards. [More info](https://www.atlassian.com/git/tutorials/comparing-workflows/) [and](http://stackoverflow.com/questions/2765421/push-a-new-local-branch-to-a-remote-git-repository-and-track-it-too).   Use   this [plugin](http://goo.gl/yKfjV) to show card numbers and reference these numbers in commits.
